...
// Test-only: proves the nonReentrant guard blocks reentrancy through the arbitrary-call surface.
contract ReentrantBundleAttacker {
    ...
    // Throwaway args are fine: nonReentrant reverts at function entry, before any arg validation.
