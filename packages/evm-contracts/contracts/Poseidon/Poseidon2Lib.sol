...
// credits: https://github.com/noir-lang/noir/blob/master/acvm-repo/bn254_blackbox_solver/src/poseidon2.rs
library Poseidon2Lib {
    ...
    ) private pure returns (Poseidon2Lib.Sponge memory) {
    ...
    ) internal pure returns (Field.Type[RATE] memory) {
        // zero-pad the cache
